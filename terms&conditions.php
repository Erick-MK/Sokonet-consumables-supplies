...
carefully before using the www.sokonet.com website (the "Service") operated by
Sokonet ("us", "we", or "our").</p>
                            <br>
...
Terms and Conditions agreement for Sokonet has been created with the help of
...
not owned or controlled by Sokonet.
Sokonet has no control over, and assumes no responsibility for, the content,
privacy policies, or practices of any third party web sites or services. You
further acknowledge and agree that Sokonet shall not be responsible or liable,
...
the new terms, please stop using the Service.</p>
                    ...
                    <h5>Visit Us for further clarification</h5>
                    <hr>
